...
namespace station {
    ...
    MeshData ShipMesh::create() {
            ...
            mesh.vertices = {
                    // 0 nose                                    pos                     RGBA                          normal (computed below)
                    {{ 0.00f,  0.80f,  0.00f}, {0.90f, 0.90f, 1.00f, 1.0f}, {0,0,0}},
                    // upper hull
                    {{ 0.00f,  0.15f,  0.22f}, {0.75f, 0.78f, 0.92f, 1.0f}, {0,0,0}}, // 1
                    {{-0.28f, -0.10f,  0.10f}, {0.55f, 0.60f, 0.82f, 1.0f}, {0,0,0}}, // 2
                    {{ 0.28f, -0.10f,  0.10f}, {0.55f, 0.60f, 0.82f, 1.0f}, {0,0,0}}, // 3
                    // lower hull
                    {{ 0.00f,  0.05f, -0.22f}, {0.38f, 0.42f, 0.62f, 1.0f}, {0,0,0}}, // 4
                    {{-0.24f, -0.14f, -0.10f}, {0.30f, 0.32f, 0.50f, 1.0f}, {0,0,0}}, // 5
                    {{ 0.24f, -0.14f, -0.10f}, {0.30f, 0.32f, 0.50f, 1.0f}, {0,0,0}}, // 6
                    // wing tips
                    {{-0.82f, -0.05f,  0.00f}, {0.48f, 0.55f, 0.85f, 1.0f}, {0,0,0}}, // 7
                    {{ 0.82f, -0.05f,  0.00f}, {0.48f, 0.55f, 0.85f, 1.0f}, {0,0,0}}, // 8
                    // tail
                    {{ 0.00f, -0.78f,  0.00f}, {0.24f, 0.28f, 0.44f, 1.0f}, {0,0,0}}, // 9
                    // dorsal fin
                    {{ 0.00f, -0.36f,  0.34f}, {0.88f, 0.52f, 0.28f, 1.0f}, {0,0,0}}, // 10
            };
